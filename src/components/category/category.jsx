      ...
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="py-10 pl-5 bg-gradient-to-br from-brandYellow to-brandYellow/90 text-white rounded-3xl relative h-[320px] flex items-end">
            ...
            <img src={Image2} alt="" className="w-[320px] absolute -right-40 lg:top-[50px]" />
          </div>

          {/* Điều chỉnh grid item này */}
          <div className="lg:col-span-2 h-auto py-10 pl-5 bg-gradient-to-br from-primary to-primary/90 text-white rounded-3xl relative flex items-end">
            <div>
              <div className="mb-4">
                <p className="mb-[2px] text-gray-400">Enjoy</p>
                <p className="text-2xl font-semibold mb-[2px]">With</p>
            ...
            <img src={Image3} alt="" className="w-[400px] absolute -right-10 lg:top-[0px]" />
          </div>
        </div>
      </div>
    </div>
